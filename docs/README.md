...
| [Functionality and performance completion](functionality-and-performance.md) | Proposed release acceptance specification, measured gaps, and phased delivery plan |
