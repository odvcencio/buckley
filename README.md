...
```bash
# Compare Claude vs GPT-4o vs your local Codellama on the same task
...
|--------------|--------------|
| **Parallel model comparison** | Run the same task across Claude, GPT-4o, and local LLMs simultaneously |
...
That's enough to start. See [docs/CONFIG.md](docs/CONFIG.md) for the full reference.
...
|----------------------------------------|---------|----------|--------|-------|
| openrouter/anthropic/claude-3.5-sonnet | ✓       | 3m 42s   | 4,231  | 6     |
| openrouter/openai/gpt-4o               | ✓       | 2m 18s   | 3,876  | 5     |
| ollama/codellama:34b                   | ✗       | 8m 12s   | 12,445 | 0     |
```
...
│                                                                 │
│  "add-dark-mode" -m claude -m gpt-4o -m codellama -p "task"    │
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────────┐
...
│                 │  │                 │  │                 │
│  Model: Claude  │  │  Model: GPT-4o  │  │ Model: Codellama│
│                 │  │                 │  │                 │
│  ┌───────────┐  │  │  ┌───────────┐  │  │  ┌───────────┐  │
