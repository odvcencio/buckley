...
func (f *FilePickerWidget) Layout(bounds runtime.Rect) {
	...
	f.FocusableBase.Layout(newBounds)
}
...
func (f *FilePickerWidget) Render(ctx runtime.RenderContext) {
	...
	if cursorX < b.X+b.Width-2 && f.IsFocused() {
...
func (f *FilePickerWidget) AccessibleLabel() string {
	return "File picker"
}

func (f *FilePickerWidget) AccessibleDescription() string {
	return "Search and select files"
}

func (f *FilePickerWidget) AccessibleState() accessibility.StateSet {
	return accessibility.StateSet{}
}

func (f *FilePickerWidget) AccessibleValue() *accessibility.ValueInfo {
	return nil
}

var _ accessibility.Accessible = (*FilePickerWidget)(nil)
