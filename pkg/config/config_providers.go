...
func isOpenRouterDefaultModel(modelID string) bool {
	...
	case defaultOpenRouterChatModel, defaultOpenRouterUtilityModel, defaultOpenRouterCommitModel, legacyOpenRouterCommitModel, legacyOpenRouterChatModel, legacyOpenRouterModel:
		return true
	default:
		return false
	}
