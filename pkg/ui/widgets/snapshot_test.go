...
// TestSnapshot_Header tests the header widget rendering.
...
// TestSnapshot_StatusBar tests the status bar widget rendering.
...
// TestSnapshot_Sidebar tests the sidebar widget rendering.
...
// TestSnapshot_Approval tests the approval widget rendering.
...
// TestSnapshot_ApprovalWithDiff tests approval widget with diff preview.
